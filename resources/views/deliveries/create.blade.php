    ...
    <div class="border-b pb-4 mb-6" style="border-color: var(--color-border);">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-sm" style="color: var(--color-text-secondary);">Create a new delivery record</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('delivery.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea name="notes" id="notes" rows="3"
                      class="w-full px-4 py-2 border rounded-md focus:outline-none"
                      style="background-color: var(--color-input-bg); border-color: var(--color-border); color: var(--color-text-primary);">{{ old('notes') }}</textarea>
            <p class="text-sm mt-1" style="color: var(--color-text-secondary);">
